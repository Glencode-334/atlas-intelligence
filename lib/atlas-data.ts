...
export const founders = [
  {
    ...
    note: "Driving the commercialization of frontier AI models.",
  },
  {
    name: "Dario Amodei",
    company: "Anthropic",
    ...
    funding: "$12B+",
    focus: "AI Safety",
    note: "Leading the safety-first foundation model movement.",
  },
  {
    name: "Aravind Srinivas",
    company: "Perplexity",
    previous: "OpenAI · DeepMind",
    funding: "$500M+",
    focus: "AI Search",
    note: "Building the next generation of answer engines.",
  },
  {
    name: "Varun Mohan",
    company: "Codeium",
    previous: "Nuro",
    funding: "$1B+ valuation",
    focus: "AI Coding",
    note: "Competing directly with GitHub Copilot and Cursor.",
  },
  {
    name: "Alexandr Wang",
    company: "Scale AI",
    ...
    note: "Critical supplier to frontier AI labs and governments.",
  },
];
